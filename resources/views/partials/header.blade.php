...
<nav class="navbar navbar-default" style="background-color:none">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#"><i class="fa fa-mobile" aria-hidden="true"></i>Mobile Phones</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
          ...
          <ul class="dropdown-menu">
            @if (Auth::check())
              ...
              <li><i class="fa fa-id-card" aria-hidden="true"><a href="#"></i>Employee Signup</a></li>
